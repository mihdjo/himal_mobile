...
@Embeddable
public class SacuvanaEkspedicijaId implements Serializable {
    ...
    public SacuvanaEkspedicijaId() {
    }

    public SacuvanaEkspedicijaId(Long idKorisnika, Long idEkspedicije) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SacuvanaEkspedicijaId)) {
            return false;
        }

        SacuvanaEkspedicijaId that = (SacuvanaEkspedicijaId) o;
